...
class betTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.info = {'cmd': "bet", "uuid":"111"}
        self.bet = {'cmd': "bet", "game_id":"ba_1", 'bet':[{'type':1,'amount':100},{'type':2,'amount':200}]}
    ...
    def test_bet(self):
        ...
        mock_rsp = normal_handle(self.info, [mock_push_socket, mock_db_socket])
