...
class DealerTestCase(unittest.TestCase):
    ...
    def test_baccarat_table(self):
        ...
        self.assertEqual([1.95,0,0,0,0],ba_paytable.paytable(winstate))

        winstate = ""
        winstate += ba_paytable.combine_winstate(Baccarat_player,ba_odds_1)
        self.assertEqual([0,2,0,0,0],ba_paytable.paytable(winstate))

        winstate = ""
        winstate +=  ba_paytable.combine_winstate(Baccarat_tie,ba_odds_8)
        self.assertEqual([1,1,9,0,0],ba_paytable.paytable(winstate))

        #multi winstate
        winstate = ""
        winstate = ba_paytable.combine_winstate(Baccarat_banker,ba_odds_095)
        winstate +=  ba_paytable.combine_winstate(Baccarat_banker_pair,ba_odds_11)
        self.assertEqual([1.95,0,0,12,0],ba_paytable.paytable(winstate))

        winstate = ""
        winstate += ba_paytable.combine_winstate(Baccarat_banker,ba_odds_095)
        winstate += ba_paytable.combine_winstate(Baccarat_banker_pair,ba_odds_11)
        winstate += ba_paytable.combine_winstate(Baccarat_player_pair,ba_odds_11)
        self.assertEqual([1.95,0,0,12,12],ba_paytable.paytable(winstate))

        winstate = ""
        winstate +=  ba_paytable.combine_winstate(Baccarat_tie,ba_odds_8)
        winstate += ba_paytable.combine_winstate(Baccarat_banker_pair,ba_odds_11)
        self.assertEqual([1,1,9,12,0],ba_paytable.paytable(winstate))
